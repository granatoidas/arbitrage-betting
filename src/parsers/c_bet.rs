...
#[async_trait]
impl BookieParser for CBetPraser {
...
impl CBetPraser {
    async fn get_content_from_page(&self) -> Result<String, Box<dyn Error>> {
        self.page
            .goto_builder("https://cbet.lt/sportas/futbolas/europa/uefa-cempionu-lyga-kvalifikacija")
